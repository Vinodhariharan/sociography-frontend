  ...
  //         id={id}
  //         photographerId={useAuth.photographerId}
  ...
  const DribbbleShot = ({
    ...
    const [comments, setComments] = React.useState(initialComments);
    const [newComment, setNewComment] = React.useState('');
    const { authState } = useAuth(); // Accessing auth state for photographerId
    ...
    return (
      <>
        ...
        <DribbbleShotDialog
          ...
          picAuthId={id} // Assuming `id` is the photographer ID for this post
        />
      </>
    );
  };
