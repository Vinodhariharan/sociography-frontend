...
import SocialBar from '../common/SocialBar'; // Import the SocialBar component

const Footer = () => {
  return (
    <Box sx={{justifyContent:'center',bgcolor:'#fff' ,alignItems:'center', display:'flex', flexDirection:'column' }}>
      <Divider sx={{ marginBottom: '2rem' , color:'black', width:'80%' }} /> {/* Divider above the footer */}
